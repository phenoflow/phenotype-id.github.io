...
primary_care_code_lists: /primary_care/CPRD_gout.csv
secondary_care_code_lists: /secondary_care/ICD_gout.csv
...
{% include csv.html csvdata=site.data.primary_care.CPRD_gout %}
...
{% include csv.html csvdata=site.data.secondary_care.ICD_gout %}
